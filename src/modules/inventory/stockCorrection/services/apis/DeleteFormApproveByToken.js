...
class DeleteFormApproveByToken {
  ...
  async call() {
    try {
      ...
      const { stockCorrection } = await new DeleteFormApprove(this.tenantDatabase, { approver, stockCorrectionId }).call();
...
module.exports = DeleteFormApproveByToken;
